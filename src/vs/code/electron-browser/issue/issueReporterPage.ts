...
<div id="issue-reporter">
	...
	<div class="input-group">
		<label for="issue-type">${escape(localize('issueTypeLabel', "This is a"))}</label>
	...
	<div id="block-container">
			...
			<details>
				<summary>${escape(localize('systemInfo', "My System Info"))}
					<input type="checkbox" id="includeSystemInfo" checked>
						<label class="caption" for="includeSystemInfo">${escape(localize('sendData', "Send this data"))}</label>
					</input>
				</summary>
			...
			<details>
				<summary>${escape(localize('processes', "Currently Running Processes"))}Currently Running Processes
					<input type="checkbox" id="includeProcessInfo" checked>
						<label class="caption" for="includeProcessInfo">${escape(localize('sendData', "Send this data"))}/label>
					</input>
				</summary>
				<div class="block-info">
					<!-- To be dynamically filled -->
			...
			<details>
				<summary>${escape(localize('workspaceStats', "My Workspace Stats"))}
					<input type="checkbox" id="includeWorkspaceInfo" checked>
						<label class="caption" for="includeWorkspaceInfo">${escape(localize('sendData', "Send this data"))}</label>
					</input>
				</summary>
		...
		<div class="block block-description">
			...
			<div class="block-info-text">
				<small>${escape(localize('githubMarkdown', "We support GitHub-flavored Markdown. After submitting, you will still be able to edit your issue on GitHub."))}</small>
